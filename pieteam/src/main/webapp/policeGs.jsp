...
<p>
    ...
    <button onclick="location='fireGs.jsp'"> 소방서</button>
    <button onclick="location='policeGs.jsp'"> 경찰서</button>
    <button onclick="location='safeGs.jsp'"> 어린이보호구역</button>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(35.1289912, 126.7854541), // 지도의 중심좌표
        level: 7 // 지도의 확대 레벨
    };
...
<%
	GsDAO dao = new GsDAO();
	List<Police> list = dao.selectAllpolGs();
