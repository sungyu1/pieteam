						...
						<div class="inner">
							...
							<%}else{ %>								
								...
								<ul class="icons">
										...
										<li><button class="custom-btn btn-12" id="fire"><span>소방서</span><span><img src="./images/소방서.png"></span></button></li>
										<li><button class="custom-btn btn-12" id="safe"><span>안전</span><span><img src="./images/학교.png"></span></button></li>
										<li><a href="login.jsp"><button class="custom-btn btn-12"><span>전체보기</span><span><img src="./images/커뮤니티.png"></span></button></a></li>
								</ul>
								</header>
							<%} %>
							<!-- map-->
...
<div class="map_wrap">
                ...
                <form>
                    ...
                    <button type="button" id="search1" onclick="searchStart()">❤</button><br>
                     <input type="text" value="" id="end" size="15" placeholder="도착지를 입력하세요"> 
                    <button type="button" id="search2" onclick="searchEnd()">❤</button> 
                </form>
            </div>
     
      <button type="button" id="reset1" onclick="reset()"><img src="./images/재검색1.png"></button>
