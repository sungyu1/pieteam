...
<p>
  	<button onclick="location='cctvN.jsp'"> CCTV</button>
    <button onclick="location='fireN.jsp'"> 소방서</button>
    <button onclick="location='policeN.jsp'"> 경찰서</button>
    <button onclick="location='safeN.jsp'"> 어린이보호구역</button>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(35.178315, 126.9198947), // 지도의 중심좌표
        level: 6 // 지도의 확대 레벨
    };
