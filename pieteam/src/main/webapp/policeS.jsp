...
<p>
  	<button onclick="location='cctvS.jsp'"> CCTV</button>
    <button onclick="location='fireS.jsp'"> 소방서</button>
    <button onclick="location='policeS.jsp'"> 경찰서</button>
    <button onclick="location='safeS.jsp'"> 어린이보호구역</button>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div  
    mapOption = { 
        center: new kakao.maps.LatLng(35.1329717, 126.9086305), // 지도의 중심좌표
        level: 6 // 지도의 확대 레벨
    };

var map = new kakao.maps.Map(mapContainer, mapOption); // 지도를 생성합니다

var imageSrc = './images/경찰차.png', // 마커이미지의 주소입니다    
...
Lat.push(<%=list.get(i).getP_lat() %>)
Lon.push(<%=list.get(i).getP_lon() %>)
Name.push("<%=list.get(i).getP_addr()%>")
tel.push("<%=list.get(i).getP_tel()%>")
